...
from utils import allen_coref, Special_consitituency_extractor_v3, imparative_to_declarative_v1
...
imp_to_dec = imparative_to_declarative_v1.ImparativeToDeclarative()
            ...
            for item in extractions:
                ...
                if context == None:
                    for arg2_item in arg2s:
                        ...
                        t.add((arg1, rel, arg2_item['text'].strip()))
