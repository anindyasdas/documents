...
# section map between section name in korean and standard english name
Section_map ={"사용하기" : "OPERATION", "설치하기": "INSTALLATION","관리하기":"MAINTENANCE", 
              "LG ThinQ 사용하기":"LGThinQ", "부록":"APPENDIX", "제품 보증서 보기":"PRODUCT_WARRANTY",
              "알아보기":"LEARN", "안전을 위해 주의하기":"SAFETY_INSTRUCTIONS",
              "안전을 위한 주의 사항":"SAFETY_PRECAUTION"}

# keywords mapping between english keys and equivalent korean translation
keywords_map={"Fridge & Freezer":"냉장고 및 냉동고",
"WASHING MACHINE": "세탁기",
"DRYER": "건조기",
"STYLER":"스타일러",
"summary":"요약",
...
S_KO_OPERATION = "사용하기"
S_KO_INSTALLATION = "설치하기"
S_KO_MAINTENANCE = "관리하기"
S_KO_USING_LG_ThinQ = "LG ThinQ 사용하기"
S_KO_APPENDIX = "부록"
S_KO_PRODUCT_WARRANTY = "제품 보증서 보기"
S_KO_LEARN = "알아보기"
S_KO_SAFETY_INSTRUCTIONS = "안전을 위해 주의하기"
S_KO_SAFETY_PRECAUTION = "안전을 위한 주의 사항"

#key correction, need to check the extraction code to avoid styling information being added to text
KEY_CORRECTION={"R 금지 사항":"금지 사항", "j 준수 사항": "준수 사항" } 

#symbols in Manual tables
SYMBOLS=["X", "#", "-", "", "$"]

#product name often combined with section name eg. "OPERATION-DRYER", "OPERATION-WASHING MACHINE"
PRODUCTS={"세탁기", "냉장고 및 냉동고", "건조기"}

#Korean Relation list check list, to be used for building keys
KO_REL_LIST=["사용하기", "청소하기", "사용하기 전 알아두기", "세탁 전",
     "세탁 후", "변경하기", "설정하기", 
     "분리","조립하기", "설정", "해제하기",
     "요약", "설명", "절차", "단계", "주의", "경고", "특징",
     "설치하기", "제거하기", "연결하기", "분리하기", 
     "해결하기", "관리하기", "준수 사항", "금지 사항"]

#Exclude list: key extraction is not required, as these keys are accessory information, not expected to be queried directly
EXCLUDE_KEY_LIST=["figure", "calloutlist","footnotegroup","footnote",  "graphic", "note", "orderedlist", "prerequisites", "단계", "방법", "설명" ]

#maximum string len to be allowed to be a key in json
MAX_STRING_LEN=80

#batch_size for embedding computation
EMB_BATCH_SIZE=100
...
class ExtractionConstants(object):
    ...
    SKIP_SECTION = ["사용하면 안 되는 의류", "건조물 분류하기", "섬유제품 관리 기호 및 설명","건조기 사용 금지 건조물"]
...
class TroubleshootingMappingRelation(object):
    ...
    SECTION_MAPPING = {
        HAS_PROBLEM: [PROBLEM, OPERATION, FUNCTION, PERFORMANCE, ODOR, WATER, ICE_AND_WATER, PARTS_AND_FEATURE,
                      ETC, CRAFT_ICE, VOICE_ASSIST, MOP_NOZZLE, REFRIG_FROZEN],
