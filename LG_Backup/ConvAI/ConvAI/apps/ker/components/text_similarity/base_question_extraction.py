...
def generate_question_list_json(info_extr, text_sim, question_type=constants.SPEC, product=constants.WASHING_MACHINE,
    ...
    """
    input_file, output_file = __get_data_type(question_type, product)
...
def __get_data_type(question_type, product):
    """
