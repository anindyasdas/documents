...
class SpecialHandler(logging.StreamHandler):
    ...
    base_path_mapper = [
        # ("ker/pkr/src/knowledge_extraction/src", "logger"),
        ("components/engine", "similarity_mapper"),
        ("components/classifier", "classifier"),
        ("components/info_extraction/rule_based", "ie/rule_based"),
        ("ker/external/constituency_parser", "ie/constituency_parser"),
        ("ker/external/srl", "ie/srl")
    ]
    ...
    def set_default_logging():
        ...
        spl_handler = RotatingFileHandler("logspecialfiles.txt", 'a+', maxBytes=10000000, backupCount=5)
        ...
        logging.basicConfig(
            ...
            handlers=[
                ...
                spl_handler,
                RotatingFileHandler("logfiles.txt", 'a+', maxBytes=10000000, backupCount=5)
            ],
            datefmt='%Y-%m-%d,%H:%M:%S')
