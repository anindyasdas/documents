...
import os.path
from .knowledge_extraction.datamodel.dminterface import DMInterface
from .knowledge_extraction.constants import params as cs
from .knowledge_extraction.docextraction.extraction import DocxTableExtractor
from .knowledge_extraction.docextraction.tablehandler import TableInfoExtractor
from .knowledge_extraction.knowledge.database import DBInterface
from .knowledge_extraction.docextraction.xml_extractor import XMLExtractor
...
if __name__ == "__main__":
    ...
    # For Verification
    # python -m apps.ker_ko.extraction_engine -v --xml_file_path <manual's .book.xml file path> --req_section Troubleshooting
    # For Populating
    # python -m apps.ker_ko.extraction_engine --xml_file_path <manual's .book.xml file path> --req_section Troubleshooting