...
class Utils:
    ...
    @staticmethod
    def translate(src_text, eng2kor=True):
        """
        Translates eng to kor and viceversa - User MIT license - https://pypi.org/project/googletrans/
        :param src_text: source text to be translated
        :param eng2kor: True if required to translate from eng to kor, False otherwise
        :return:
        """
        if eng2kor:
            translated = translator.translate(src_text, src='en', dest='ko')
        else:
            translated = translator.translate(src_text, src='ko', dest='en')
