...
class Utils:
    ...
    @staticmethod
    def split_train_test(input_file, stratify_on: list, sheet_name='data-set'):
        """
    ...
    def read_input(path, header=0, delimiter=" "):
        """
    ...
    def write_file(data: pd.DataFrame, write_header=True, save_path="output.csv", delimiter=" "):
        """
...
if '__main__' == __name__:
    x, y = Utils.split_train_test('WM_REF_TROB.xlsx', ['Key', 'Reason/Solution', 'Level', 'Product'])
    Utils.append_df_to_excel("train.xlsx", x, "train_data")
    Utils.append_df_to_excel("test.xlsx", y, "test_data")