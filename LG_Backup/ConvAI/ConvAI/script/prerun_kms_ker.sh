...
sed -i 's/host.docker.internal:..../host.docker.internal:8042/' ${DIR}/../apps/ker/knowledge_extraction/config/configuration.ini
sed -i 's/host.docker.internal:..../host.docker.internal:8042/' ${DIR}/../apps/ker/configuration.ini

# Change ker_ko server port for connection
sed -i 's/^port_number = .*$/port_number = 8007/' ${DIR}/../apps/ker/knowledge_extraction/config/configuration.ini

# Change runserver.sh
git checkout ${DIR}/../runserver.sh
sed -i 's/0.0.0.0:.*$/0.0.0.0:8082/' ${DIR}/../runserver.sh
